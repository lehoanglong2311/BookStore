        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                   <a class="btn btn-info" href="home"><i class="fa fa-home" aria-hidden="true"></i>Home</a> 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-info mb-2" type="submit">update</button>
                                     ...
                                     <a href="#deleteProductModal " class="delete btn btn-warning" data-id="${o.id}" data-toggle="modal">delete </a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.delete').click(function () {
                    ...
                    // Đặt giá trị ID vào hidden input trong form xóa
                    $('input[name="pid"]').val(productId);
                });
            });
        </script>
    </body>
